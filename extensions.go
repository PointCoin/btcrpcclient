...
//
// NOTE: This is a wallet extension.
...
// managed by wallet are only written to disk with encrypted private keys,
...
// used by wallet to enable a wallet which does not have the private keys
